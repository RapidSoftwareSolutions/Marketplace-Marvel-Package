<?php
$app->post('/api/Marvel/getComicsBySeries', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['publicKey', 'privateKey', 'seriesId']);
    ...
    $query_str = $settings['api_url'] . "v1/public/series/" . $post_data['args']['seriesId'] . '/comics';
    $body = array();
