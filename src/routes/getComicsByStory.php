<?php
$app->post('/api/Marvel/getComicsByStory', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['publicKey', 'privateKey', 'storyId']);
    ...
    $query_str = $settings['api_url'] . "v1/public/stories/" . $post_data['args']['storyId'] . '/comics';
    $body = array();
