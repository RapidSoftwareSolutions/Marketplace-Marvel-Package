<?php
$app->post('/api/Marvel/getComicsByCharacter', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . "v1/public/characters/" . $post_data['args']['characterId'] . '/comics';
    $body = array();
