<?php
$app->post('/api/Marvel/getCharactersBySeries', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . "v1/public/series/" . $post_data['args']['seriesId'] . "/characters";
    $body = array();
