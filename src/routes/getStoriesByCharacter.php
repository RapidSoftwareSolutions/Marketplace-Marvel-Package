<?php
$app->post('/api/Marvel/getStoriesByCharacter', function ($request, $response, $args) {
    ...
    $query_str = $settings['api_url'] . "v1/public/characters/" . $post_data['args']['characterId'] . '/stories';
    $body = array();
