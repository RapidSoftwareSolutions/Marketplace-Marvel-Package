<?php
$app->post('/api/Marvel/getComicsByEvent', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['publicKey', 'privateKey', 'eventId']);
    ...
    $query_str = $settings['api_url'] . "v1/public/events/" . $post_data['args']['eventId'] . '/comics';
    $body = array();
