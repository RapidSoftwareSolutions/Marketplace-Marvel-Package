<?php
$app->post('/api/Marvel/getStoriesByComic', function ($request, $response, $args) {
    $settings = $this->settings;

    //checking properly formed json
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['publicKey', 'privateKey', 'comicId']);
    ...
    $query_str = $settings['api_url'] . "v1/public/comics/" . $post_data['args']['comicId'] . '/stories';
    $body = array();
